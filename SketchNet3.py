...
class PointNetfeat(nn.Module):
    def __init__(self, num_points =numpoints, global_feat = True):
...
class PointLocalFeat3(nn.Module):
    def __init__(self, num_points = numpoints, global_feat = True):
        super(PointLocalFeat3, self).__init__()
        self.k = 30
...
class SketchSeg(nn.Module):
    def __init__(self, num_points = numpoints, k = 4):
        super(SketchSeg, self).__init__()
        self.num_points = num_points
        self.k = k
        self.feat = PointNetfeat(num_points, global_feat=False)
        self.localfeat = PointLocalFeat3(num_points, global_feat=False)
        self.conv1 = torch.nn.Conv1d(2176, 1024, 1)
