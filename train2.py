...
cate = 'Guitar'
train_dataset = PartDataset(root = 'test250', npoints = numpoints, class_choice = cate)

train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=opt.batchSize,
                                          shuffle=True, num_workers=int(opt.workers))

test_dataset = PartDataset(root = 'test250', npoints = numpoints, class_choice = cate, train = False)
